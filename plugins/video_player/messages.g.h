...
template<class T> class ErrorOr {
 ...
 private:
  friend class AVFoundationVideoPlayerApi;
  ErrorOr() = default;
...
class TextureMessage {
 ...
 private:
  ...
  friend class AVFoundationVideoPlayerApi;
  friend class AVFoundationVideoPlayerApiCodecSerializer;
  int64_t texture_id_;
...
class AVFoundationVideoPlayerApiCodecSerializer : public flutter::StandardCodecSerializer {
 public:
  AVFoundationVideoPlayerApiCodecSerializer();
  inline static AVFoundationVideoPlayerApiCodecSerializer& GetInstance() {
    static AVFoundationVideoPlayerApiCodecSerializer sInstance;
    return sInstance;
  }
...
class AVFoundationVideoPlayerApi {
 public:
  AVFoundationVideoPlayerApi(const AVFoundationVideoPlayerApi&) = delete;
  AVFoundationVideoPlayerApi& operator=(const AVFoundationVideoPlayerApi&) = delete;
  virtual ~AVFoundationVideoPlayerApi() {}
 ...
 protected:
  AVFoundationVideoPlayerApi() = default;
