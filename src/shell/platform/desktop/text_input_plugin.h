...
#ifndef FLUTTER_SHELL_PLATFORM_DESKTOP_TEXT_INPUT_PLUGIN_H_
#define FLUTTER_SHELL_PLATFORM_DESKTOP_TEXT_INPUT_PLUGIN_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_DESKTOP_TEXT_INPUT_PLUGIN_H_
